...
public class Trees {
    ...
    public static class PennTreeReader implements Iterator<Tree<String>> {
        ...
        public static String ROOT_LABEL = "ROOT^g";
        PushbackReader in;
        ...
        public PennTreeReader(Reader in) {
            ...
            nextTree = readRootTree();
            if (nextTree == null) {
                System.err.println("I cannot read any tree...");
            }
        //System.out.println(nextTree);
        }

        public PennTreeReader(String treeLine) {
            Reader lineIn = new StringReader(treeLine);
            this.in = new PushbackReader(lineIn);
            nextTree = readRootTree();
        }
        
        public static Tree<String> readTreeFromLine(String treeLine) {
            Iterator<Tree<String>> treeIterator = new PennTreeReader(treeLine);
